...
print("\n------- Stats: PUPI-class --------")
#print(stats2)
print("Best costs (%s): " % "eggholder", [results[1] for results in stats2 if results[0] == "eggholder"])
print("Best evals (%s): " % "eggholder", [results[2] for results in stats2 if results[0] == "eggholder"])
print("Best times (%s): " % "eggholder", [results[4] for results in stats2 if results[0] == "eggholder"])
